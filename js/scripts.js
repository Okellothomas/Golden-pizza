...
$(document).ready(function(){
    ...
    Small.prototype.pizzaPrice = function(){
        ...
        if(parseInt(this.pizano) <= 0 || toppingPrices <= 0 || custPrices <= 0){
            ...
            alert("Your Pizza Costs " + totalCost1 + " Thank your for shopping with us, come again.");
        }
        ...
        $('button#checkout').click(function(e){
            ...
            if(grandTotal <= 0){
                ...
                alert('Your total cost for small Pizza is: ' + grandTotal + " Please choose your destination");
                $('#hide').show();
            }
...
$(document).ready(function(){
    ...
    Small.prototype.pizzaPrice = function(){
        ...
        if(parseInt(this.pizano) <= 0 || toppingPrices <= 0 || custPrices <= 0){
            ...
            alert("Your Pizza Costs " + totalCost2 + " Thank your for shopping with us, come again.");
        }
        ...
        $('button#checkout').click(function(e){
            ...
            if(grandTotal <= 0){
                ...
                alert('Your total cost for Medium Pizza is: ' + grandTotal + " Please choose your destination");
                $('#hide').show();
            }
        });
...
$(document).ready(function(){
    ...
    Small.prototype.pizzaPrice = function(){
        ...
        if(parseInt(this.pizano) <= 0 || toppingPrices <= 0 || custPrices <= 0){
            ...
            alert("Your Pizza Costs " + totalCost3 + " Thank your for shopping with us, come again.");
        }
        ...
        $('button#checkout').click(function(e){
            ...
            if(grandTotal <= 0){
                ...
                alert('Your total cost is Large Pizza is: ' + grandTotal + " Please choose your destination");
                $('#hide').show();
            } 
        });
...
//         alert('this is true');
//         debugger;
//         var grandTotal = totalCost1 + totalCost2 + totalCost3;
//         alert('Your total cost is: ' + grandTotal + "Choose your destination");
